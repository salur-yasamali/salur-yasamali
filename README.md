...
- 💡 **Araçlarım:** Ürün kararlarını içgüdülerle değil, somut verilerle almak için SQL (MS SQL Server) ve Python (Pandas) kullanıyorum. Ayrıca şube ve ürün performansını anlık simüle etmek, hızlı P&L ve finansal modellemeler yapmak için İleri Seviye Excel yetkinliğimi aktif olarak geliştiriyorum.
